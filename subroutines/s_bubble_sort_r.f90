subroutine s_bubble_sort_r(array_s,array_o,array_i)
!
! Bubble sort method:
!
! https://en.wikipedia.org/wiki/Bubble_sort
!
! This is the floating point version of the method.
!
! The code bellow sorts the elements of the floating point array
...
real(C_FLOAT),intent(inout) :: array_o(array_s)
...
end subroutine s_bubble_sort_r
